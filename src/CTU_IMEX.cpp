...
//	ddpPrintGrid(electrolyte_grid);
    ...
    int converge_counter_period		= 1000;
    ...
    tDelta = 0.04;
    //problem.increase_time_step_factor * tDeltaProposed;
...
//					grvy_timer_begin("Check converged");
                    ...
                    if(semiconductor_converged)
                    {
                        ...
                        // increase it by increased_time_step_factor
                        tDelta = 1.0; // problem.increase_time_step_factor * tDeltaProposed;
...
//						tDelta = 1.0;
            ...
            else
            {
                ...
                // Assemble the RHSes for the LDG systems
                ////////////////////////////////////////////////////////////////////
                TimeStepper.UpdateExplicitElectrolyteDriftTerms(reductants,
                        oxidants,
                        Poisson);
