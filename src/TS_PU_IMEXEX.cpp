    ...
    for(timeStampLabel=1; timeStampLabel < timeStamps.size(); ++timeStampLabel)
    {
        ...
        while(tCurrent < tNext)
        {
            ...
            for(int k=0; k < scale; k++)
            {
                ...
                ////////////////////////////////////////////////////////////////////
                TimeStepper.UpdateExplicitSemiconductorDriftTerms(
                    electrons,
                    holes,
                    Poisson);

                TimeStepper.AssembleBackwardEulerSemiconductorRHS(
                    electrons,
                    holes,
                    reductants,
                    oxidants,
            ...
            tCurrent += scale * tDelta;



            TimeStepper.UpdateExplicitElectrolyteDriftTerms(
                reductants,
                oxidants,
                Poisson);

            TimeStepper.AssembleBackwardEulerElectrolyteRHS(
                electrons,
                holes,
                reductants,
                oxidants,
